...
export const ExploreDaos = () => {
   const { daos, loading, fetchDAO } = useApp();
   ...
   const handleSearchDao = async()=>{
      const daoIdToSearch = searchTerm.toLowerCase();
      await fetchDAO(daoIdToSearch);
   }
      ...
      <div className="min-h-screen container mx-auto px-4 py-8 pb-20">
         <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
            ...
            <div className="flex w-full md:w-auto gap-2">
               ...
               <Button variant="secondary" onClick={handleSearchDao}>Search</Button>
            </div>
         </div>
